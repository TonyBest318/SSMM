...
save_path = strcat('run_logs/', string(current_time, 'yyyyMMdd_HHmmss'));
mkdir(save_path);
...
u0 = p.K_min;    % stiffness K hold constant in this simulation
...
y_init(1, :) = x0;
K_traj_initial = initialStiffness(u0, 0.0, p);
