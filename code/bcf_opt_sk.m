...
save_path = strcat('run_logs/', string(current_time, 'yyyyMMdd_HHmmss'), '_bcf');
mkdir(save_path);
...
% Kx = open('bcf_x_it_132_0.342271.mat').x;
...
function save_force_csv(thrust_y, theta_all, p)
    % Create table with column names
    data_table = table(p.t_sol', thrust_y, theta_all(:, 1), ...
        'VariableNames', {'Time_s', 'Total_Thrust_Y_N', 'wave'});
